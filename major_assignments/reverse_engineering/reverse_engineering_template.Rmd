...
* **Analysis summary**: I was able to confirm the finding for the first part of the sentence, which stated that black women accounted for less than 1 percent of overall fatal shootings. However, when I calculated the remaining two parts of the sentence, I couldn't confirm the finding. The sentence states that black women account for 20% of women shot, but I got 18%. The more troubling of the two not confirmed was the last part. My work found that 12.6% of all unarmed deaths were black women, but the sentence states they account for 28%. My only explanation at this point would be that they included the "undetermined" entries in the unnamed category as well.
