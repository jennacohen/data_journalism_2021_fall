...
**Answer** It has 8530 rows and 13 columns, mainly describing the doses totals for each county for each day.
...
**Answer** It has each county with the total amount of days they have been vaccinating people. One interesting observation is that the days of vaccination vary between counties, meaning that counties did not start vaccinating people on the same day. There is also an NA county that has a count of 201 vaccination days, which is interesting. 
...
**Answer** I feel as though this data is either an error or a control to make sure you are able to add information into the dataset. There are no counties listed and some of the math between the first dose daily and first dose cumulative doesn't line up. For example, object 34 lists NA for their first dose daily, but 8004 for first dose cumulative.
...
**Answer** There was a consistent pattern in that there were several hundred people fully vaccinated each day, but the days aren't highly ranked. Also, Sunday 11/14, there was a significant drop in fully vaccinated individuals. 
...
**Answer** The number of vaccinations per day is going down over time. 
...
**Answer** [1] "The number of people in Prince George's County fully vaccinated on November 14 decreased by -74.25 percent compared to the week before"
...
**Answer**It shows a line chart of cases for each county. the colors are a bit similar.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** It shows a better visual of how cases rose in the MD counties. 
...
**Answer** A color break down of cases in the different counties for 11/14.
