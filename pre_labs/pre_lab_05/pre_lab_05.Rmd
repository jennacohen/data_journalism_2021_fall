...
**Answer** Different spelling and cases separate cities that are the same city. 
...
**Answer** Gaithersburg and Westminster cities were both changed from uppercase to title case. 
...
**Answer** Merged Abingdon in uppercase to title case, Accident from uppercase to title case, Accokeek from small case to title case. 
...
**Answer** No, the data looks relatively the same. 
