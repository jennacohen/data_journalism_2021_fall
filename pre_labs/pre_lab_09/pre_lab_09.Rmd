...
**Answer** The first line stores the data in the dataframe called maryland_ppp_top_counties. It then groups the data by project_county_name, counts them and names the count total_loans. It then arranges the dataframe in descending order based on the total_loan count and lastly, asks to show the first 10 rows of data.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart, with overlapping county names on the x axis. They also are in alphabetical order. 
...
**Answer** A more organized chart from lowest total loans to highest, however the names are still overlapping on the bottom. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The chart orientation has flipped to display counnties on the y axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background of this chart is white with grid lines rather than grey. 
...
**Answer** There's a pale blue background and lines only run horizontally. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The tables are updated with more appropriate labels as well as a title at the top
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A dataframe with a count of total loans approved on each date listed in the ppp_maryland dataframe. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A very basic line draft displaying the dataframe from task 12. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There are many more labels on the x axis. However they all over lap making them not useful. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The labels are now much more readable as they've been tilted. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
