...
**Answer** It prints the list, but only prints 1 of the repeated word "cat."
...
**Answer** I removes all punctuation from words and makes them all lowercase.
...
**Answer** It isn't super interesting, as they are mostly articles that string words together (the, to, and, of, in)
...
**Answer** It is more interesting before. It clearly highlights the mention of COVID. However, it's tricky because it has several words that relate to covid: covid, 19, covid19, coronavirus.
...
**Answer** It produces a list of single words with the number of occurrences they each have and their percentage of overall words.
...
**Task** Run the following code and describe the results.
**Answer** A similar list applies here but instead of singular words, they're in pairs. They are all related to covid in some way: covid 19, health care, public health, etc.
...
**Task** Run the following code and describe the results.
**Answer** In a similar format, vaccine related phrases were the main things that appeared on the 2021 list. The phrases related to health care/public health specifically were mentioned less compared to the previous task. 
...
**Task** Run the following code and describe the results.
**Answer** The Democrat list and Republican list were relatively similar- all relating to COVID once again. However the main difference that appears is that social distancing is on the dems list. This is the first time this word has popped up. It can lead you to ask more questions about the reasons behind this, were different parties recommending different measures for COVID in 2020?
...
**Task** Run the following code and describe the results.
**Answer** These are bit more interesting- along with phrases related to covid, illegal immigrants, joe biden and biden administration all pop up. There are also a couple phrases that all refer to the vaccine in some way.
...
**Answer** I think a lot of it depends on the context in which the word is used. For example, the 2020 list lists critical as negative. However, depending on the context, it could be a positive. ie. The front line workers are critical in treating pandemic patients.
