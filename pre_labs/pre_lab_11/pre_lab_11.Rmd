...
**Answer** 6 different hospital files including a shape file, projection file and XML file. 
...
**Answer** There are Rows: 7,581 and Columns: 33. These columns include:
$ OBJECTID   
$ ID         
$ NAME       
$ ADDRESS   
...
**Answer** Details from the data frame for the 72 hospitals in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The types and counts of hospitals in MD. The type of hospital that's most seen across the state are general acute care hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Similar descriptions of the data frame with 50 general acute care hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A scatterplot on a lat/long axis which roughly makes out the shape of MD. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It poops up with a message: To enable 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It describes the 18 cloumns and gives a glimpse at the 3,233 rows. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It created a new dataframe called md_counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's a county map of MD on the lat/long plot. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the layers of our two outputs from previous tasks. A county map of MD with the scatter plot of hospitals over top. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The points on the scatter plot have now been color coded to also show the number of beds. However it's a bit hard to distinguish as the last two colors are pretty similar. 
...
**Answer** It notes that it is attaching the packages.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the same desciption of the dataframe from the previous tasks- showing specifically info about general acute care hospitals. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It counts the total number of beds in each county and arranges them in descending order. Baltimore city has the most beds with 4505.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It loads the county and population for each MD county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's a new column called geometry. It contains the "MULTIPOLYGON" data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Has all counties listed in caps with their count of total beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The data frame was cleaned to with renaming and mutates to be able to join them together. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the county, population, total beds and geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The NA values are converted to 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Math is done to calculate the beds per 100k people. Baltimore City still ranks the highest ith 739 beds per 100k. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map filled with counties in colors that describe their number of beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The same map with more differntiated colors. 
...
**Answer** That the center region of MD has much fewer beds per capita than I expected. Weatern MD and the Eastern Shore have higher bed counts per 100k. 
