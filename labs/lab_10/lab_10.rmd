...
write_csv(top_ten_undisbursed, "data/top_ten_states_undisbursed_loans.csv")
...
write_csv(barber_apps_percent_undis, "data/barber_apps_percent_undisbursed.csv")
